...
<head>
    <meta charset="utf-8" />
    <title>Création de classe piège</title>
...
<body>
    ...
    <form action="" method="post" >
        <h2>Création de classe piège</h2>
        <?php
        ...
        <input type="text" name="nom_classe_piege" placeholder='Nom de la classe piège'/>
    ...
    <?php
        ...
        if (isset($_POST['submit'])){
            $resu = $cnx->exec("
                INSERT INTO classe_piege(nom_classe_piege, id_createur) 
                VALUES ('".$_POST['nom_classe_piege']."', ".$log[0][0].")");
